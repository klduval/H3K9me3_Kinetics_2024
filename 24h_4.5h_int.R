...
K9_4.5hpf <- read_delim("/Users/mangofrog7/Documents/Graduate_School/Projects/bioinformatics/K9anti_CnR_5.2022/peaks/ann2/K9abcam_4.5hpf_final.bed.TEann_35_0.1filt_counts.bed", col_names = col_names) %>% 
  rename(count_4.5h = count)

K9_24hpf <- read_delim("/Users/mangofrog7/Documents/Graduate_School/Projects/bioinformatics/K9anti_CnR_5.2022/peaks/ann2/K9abcam_24hpf_final.bed.TEann_35_0.1filt_counts.bed", col_names = col_names) %>% 
...
ggsave("/Users/mangofrog7/Documents/Graduate_School/Papers/K9_Kinetics/Fig6/K9_gain_loss_24h.pdf", plot = K9_gain_loss_24h, width = 3, height = 2.8, units = "in")
...
ggsave("/Users/mangofrog7/Documents/Graduate_School/Papers/K9_Kinetics/Fig6/LTR_loss.pdf", plot = LTR_loss, width = 3, height = 2.8, units = "in")
...
DNA_fam_gain <- ggplot(DNA_skinny, aes(x = Family, y = prop_skew)) + 
  ...
  stat_pvalue_manual(DNA_gain_loss_24h_ttest, label = "p = {p.adj}", hide.ns = TRUE, size = 2.5, tip.length = 0.01, 
                     xmin = "Family", xmax = "Family")
ggsave("/Users/mangofrog7/Documents/Graduate_School/Papers/K9_Kinetics/Fig6/DNA_fam_gain_noleg.pdf", plot = DNA_fam_gain, width = 3.85, height = 2.25, units = "in")

...
peak_amplitude <- read_delim("4.5h_24h_shared_peaks_matrix.tab", delim = '\t', skip = 2) %>%
...
ggsave("K9_Kinetics/FigS10/TEprops_4.5hpf_pie.pdf", plot = K9_mat_amp_diff, width = 2, height = 3, units = "in")

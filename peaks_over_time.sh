...
for infile in "$peak_file1" "$peak_file2" "$peak_file3" "$peak_file4" "$peak_file5" "$peak_file6"
do
  if [ -e "$infile" ] ; then
...
if [ -f "$peak_file1" ] && [ -f "$peak_file2" ] && [ -f "$peak_file3" ] && [ -f "$peak_file4" ] && [ -f "$peak_file5" ] && [ -f "$peak_file6" ] && [ ! -f "$peak_file7" ]; then
  num_timepoints=6
  echo "...There are $num_timepoints timepoints"
elif [ -f "$peak_file1" ] && [ -f "$peak_file2" ] && [ -f "$peak_file3" ] && [ -f "$peak_file4" ] && [ -f "$peak_file5" ] && [ ! -f "$peak_file6" ] && [ ! -f "$peak_file7" ]; then
  num_timepoints=5
  echo "...There are $num_timepoints timepoints"
elif [ -f "$peak_file1" ] && [ -f "$peak_file2" ] && [ -f "$peak_file3" ] && [ -f "$peak_file4" ] && [ ! -f "$peak_file5" ] && [ ! -f "$peak_file6" ] && [ ! -f "$peak_file7" ]; then
  num_timepoints=4
